...
const hex_ts_1 = require("https://deno.land/std@0.168.0/encoding/hex.ts");
const corsHeaders = {
...
(0, server_ts_1.serve)(async (req) => {
    ...
    try {
        ...
        const payload = body ? JSON.parse(body) : await req.json();
...
async function sendStatusNotification(supabase, etchPacket, event, updateData) {
...
async function generateSignature(payload, secret) {
    ...
    return (0, hex_ts_1.encode)(new Uint8Array(signature));
}
