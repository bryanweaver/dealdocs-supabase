<template>
  <div class="card go-to-card" @click="goToQuestions">
    <div class="card-content">
      <div class="icon-container">
        <i class="pi pi-question-circle text-white text-3xl"></i>
      </div>
      <h2>Go to Questions</h2>
      <p class="description">Complete your contract with guided questions</p>
